...
import { AlertTriangle, Bot, RefreshCw, Search, Settings, CheckCircle, Activity } from "lucide-react";
...
const typeConfig: Record<string, { icon: typeof AlertTriangle; color: string; bg: string }> = {
  ...
  recommendation: { icon: Bot, color: "text-violet-500", bg: "bg-violet-500/10" },
  discovery: { icon: Search, color: "text-amber-500", bg: "bg-amber-500/10" },
  update: { icon: Settings, color: "text-emerald-500", bg: "bg-emerald-500/10" },
  resolve: { icon: CheckCircle, color: "text-muted-foreground", bg: "bg-muted" },
};
