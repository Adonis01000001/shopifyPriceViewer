  ...
  const alerts = [
    {
      ...
      message: `${products[0].title.slice(0, 80)} price dropped 15% — immediate attention required.`,
      triggerPrice: "110.49",
    ...
    },
    {
      ...
      message: `Walmart changed price for ${products[1].title.slice(0, 60)} — review recommended.`,
      isRead: false,
      isResolved: false,
      isNotified: false,
    },
    {
      ...
      message: `${products[2].title.slice(0, 60)} crossed your 10% threshold setting.`,
      triggerPrice: "314.99",
      triggerCondition: "below" as const,
      isRead: false,
      isResolved: false,
    ...
    },
    {
      ...
      message: `${(products[3] || products[0]).title.slice(0, 60)} price increased 3% on Best Buy.`,
      isRead: true,
      isResolved: false,
      isNotified: false,
    },
    {
      ...
      message: `Amazon dropped price for ${(products[4] || products[0]).title.slice(0, 60)} — consider matching.`,
      isRead: false,
      isResolved: true,
      isNotified: false,
    },
